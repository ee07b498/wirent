	...
	<div class="card">
		...
		<div class="feed item clearfix">
			<div ng-repeat="item in Question.current_question.answers_with_user_info">
				<div class = "vote">
					<div ng-click="Question.vote({id:row.id,vote:1})" class="up">赞 [: item.upvote_count:]</div>
					<div ng-click="Question.vote({id:row.id,vote:2})" class="down">踩 [: item.downvote_count:]</div>
				</div>
