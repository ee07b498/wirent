<div class="hbox hbox-auto-xs hbox-auto-sm" ng-controller="UploadCtrl"  nv-file-drop="" uploader="uploader" filters="queueLimit, customFilter">
  ...
  <div class="col">
    ...
    <div class="wrapper-md">
      ...
      <div>
        ...
        <p class="text-muted m-t-xl">Note: upload.php file included, files will be uploaded to "src/js/uploads".</p>
      </div>
    </div>
  </div>
</div>