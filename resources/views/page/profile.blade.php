<div class="page-container row-fluid" ng-controller="ProfileController">
						...
						<div class="span12">
							...
							<div class="tabbable tabbable-custom tabbable-full-width">
								...
								<ul class="nav nav-tabs">
									...
									<li ng-class="{'active': tabs[0]}" style="border-top:2px solid red">
										<a href ng-click="tab(0)">Overview</a>
									</li>

									<li ng-class="{'active': tabs[1]}">
										<a  href ng-click="tab(1)">Profile Info</a>
									</li>

									<li ng-class="{'active': tabs[2]}">
										<a href ng-click="tab(2)">Account</a>
									</li>

									<li ng-class="{'active': tabs[3]}">
										<a href ng-click="tab(3)">Projects</a>
									</li>

									<li ng-class="{'active': tabs[4]}">
										<a href ng-click="tab(4)">Help</a>
									</li>
								...
								<div class="tab-content">
									...
									<div class="tab-pane row-fluid active"  ng-class="{'active': tabs[0]}">

										<ul class="unstyled profile-nav span3">

											<li><img src="img/profile-img.png" alt="" />
								...
								<!--			<li>
										...
										<div class="span9">
											...
											<div class="tabbable tabbable-custom tabbable-custom-profile">
												...
												<ul class="nav nav-tabs">
													...
													<li ng-class="{'active': tabs_sum[0]}">
														<a href ng-click="tab_sum(0)">Latest Customers</a>
													</li>

													<li ng-class="{'active': tabs_sum[1]}">
														<a href ng-click="tab_sum(1)">Feeds</a>
													</li>
												...
												<div class="tab-content">
													...
													<div class="tab-pane active" ng-class="{'active': tabs_sum[0]}">
															...
															<table class="table table-striped table-bordered table-advance table-hover">
																...
																<tbody>
																	...
																	<tr>
																		...
																		<td>
																			<a class="btn mini green-stripe" href="#">View</a>
																		</td>
																	...
																	<tr>
																		...
																		<td>
																			<a class="btn mini red-stripe" href="#">View</a>
																		</td>
													...
													<div class="tab-pane" ng-class="{'active': tabs_sum[1]}">
									...
									<div class="tab-pane profile-classic row-fluid" ng-class="{'active': tabs[1]}">

										<div class="span2"><img src="img/profile-img.png" alt="" />
											<a href="#" class="profile-edit">edit</a>
										</div>
									...
									<div class="tab-pane row-fluid profile-account" ng-class="{'active': tabs[2]}">
											...
											<div class="span12">
												...
												<div class="span3">
													...
													<ul class="ver-inline-menu tabbable margin-bottom-10">
														...
														<li ng-class="{'active': tabs_accounts[0]}">

															<a href ng-click="tab_account(0)">
														...
														<li ng-class="{'active': tabs_accounts[1]}">
															<a href ng-click="tab_account(1)"></i> Change Avatar</a>
														</li>

														<li ng-class="{'active': tabs_accounts[2]}">
															<a href ng-click="tab_account(2)"><i class="icon-lock"></i> Change Password</a>
														</li>

														<li ng-class="{'active': tabs_accounts[3]}">
															<a href ng-click="tab_account(3)"><i class="icon-eye-open"></i> Privacity Settings</a>
														</li>
												...
												<div class="span9">
													...
													<div class="tab-content">
														...
														<div class="tab-pane" ng-class="{'active': tabs_accounts[0]}">
														...
														<div class="tab-pane" ng-class="{'active': tabs_accounts[1]}">

															<div style="height: auto;" id="accordion2-2" class="accordion">
														...
														<div class="tab-pane" ng-class="{'active': tabs_accounts[2]}">

															<div style="height: auto;" id="accordion3-3" class="accordion">
														...
														<div class="tab-pane" ng-class="{'active': tabs_accounts[3]}">

															<div style="height: auto;" id="accordion4-4" class="accordion">
									...
									<div class="tab-pane row-fluid" ng-class="{'active': tabs[4]}">
											...
											<div class="span12">
												...
												<div class="span3">
													...
													<ul class="ver-inline-menu tabbable margin-bottom-10">
														...
														<li>
															<a data-toggle="tab" href="#tab_2"><i class="icon-group"></i> Membership</a>
														</li>

														<li>
															<a data-toggle="tab" href="#tab_3"><i class="icon-leaf"></i> Terms Of Service</a>
														</li>

														<li>
															<a data-toggle="tab" href="#tab_1"><i class="icon-info-sign"></i> License Terms</a>
														</li>

														<li>
															<a data-toggle="tab" href="#tab_2"><i class="icon-tint"></i> Payment Rules</a>
														</li>

														<li>
															<a data-toggle="tab" href="#tab_3"><i class="icon-plus"></i> Other Questions</a>
														</li>
